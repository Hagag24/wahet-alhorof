...
export const lessons: Lesson[] = [
  {
    ...
    color: '#7C5CFF',
    order: 1,
    story: 'مريم عمرها ست سنوات. يوسف عمره تسع سنوات. يوسف يساعد أمه وأباه. مثل شراء الأكل من المتجر. يوسف يركب الدراجة إلى المتجر. مريم تشعر بالحزن لأنها تريد مساعدة والديها.',
    storyScenes: [
    ...
    sections: {
      ...
      warmup: [
        { 
          ...
          description: 'استمع للصوت واختر الفقاعة الصحيحة من (ب، د، ر) لإكمال كلمة جدي دون كشف الإجابة عند الخطأ.',
          interactive: true,
          scenario: {
            character: 'جدي',
            missingWord: 'جدي',
    ...
    games: [
      ...
      },
      {
        ...
        icon: '✏️',
        questions: [
          { id: 'q1', word: 'م', question: 'أين يوجد حرف م في أول الكلمة؟', audioText: 'أين يوجد حرف ميم في أول الكلمة؟', options: ['متجر', 'أمي', 'كريم', 'بيت'], correctAnswer: 'متجر' },
          { id: 'q2', word: 'م', question: 'أين يوجد حرف م في وسط الكلمة؟', audioText: 'أين يوجد حرف ميم في وسط الكلمة؟', options: ['أمي', 'متجر', 'كريم', 'بيت'], correctAnswer: 'أمي' },
          { id: 'q3', word: 'م', question: 'أين يوجد حرف م في آخر الكلمة؟', audioText: 'أين يوجد حرف ميم في آخر الكلمة؟', options: ['كريم', 'متجر', 'أمي', 'بيت'], correctAnswer: 'كريم' },
          { id: 'q4', word: 'م', question: 'صيد النجوم: اجمع النجمة التي يظهر فيها حرف م في آخر الكلمة', audioText: 'صيد النجوم: اجمع النجمة التي يظهر فيها حرف ميم في آخر الكلمة', options: ['أمي', 'مريم', 'متجر', 'بيت'], correctAnswer: 'مريم' },
        ],
      },
      {
        id: 'game-1-5',
        ...
        icon: '📍',
        questions: [
          { id: 'q1', word: 'متجر', question: 'أين يوجد صوت م في كلمة متجر؟', audioText: 'أين يوجد صوت ميم في كلمة متجر؟', options: ['أول الكلمة', 'وسط الكلمة', 'آخر الكلمة'], correctAnswer: 'أول الكلمة' },
          { id: 'q2', word: 'كريم', question: 'أين يوجد صوت م في كلمة كريم؟', audioText: 'أين يوجد صوت ميم في كلمة كريم؟', options: ['أول الكلمة', 'وسط الكلمة', 'آخر الكلمة'], correctAnswer: 'آخر الكلمة' },
          { id: 'q3', word: 'أمي', question: 'أين يوجد صوت م في كلمة أمي؟', audioText: 'أين يوجد صوت ميم في كلمة أمي؟', options: ['أول الكلمة', 'وسط الكلمة', 'آخر الكلمة'], correctAnswer: 'وسط الكلمة' },
        ],
      },
    ],
  },
