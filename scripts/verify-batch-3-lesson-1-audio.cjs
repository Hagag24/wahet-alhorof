#!/usr/bin/env node
/**
 * Batch 3: Lesson 1 Audio Verifier
 * Verifies Lesson 1 story scenes and lesson content
 */
...
const BATCH_CONFIG = {
  name: 'Batch 3 - Lesson 1 Audio',
  description: 'Lesson 1 content: story-01 scenes and lesson audio',
  requiredIds: [
    // Story 01 scenes (Lesson 1)
    'story-01-scene-01', 'story-01-scene-02', 'story-01-scene-03', 'story-01-scene-04',
    'story-01-scene-05', 'story-01-scene-06',
    // Lesson 1 content
    'lesson-1-full', 'lesson-1-objectives', 'lesson-1-objectives-2', 'lesson-1-objectives-3',
    'lesson-1-objectives-4', 'lesson-1-objectives-5', 'lesson-1-objectives-6', 'lesson-1-objectives-7',
...
async function verifyBatch() {
  ...
  const reportPath = path.join(REVIEW_DIR, 'batch-3-lesson-1-audio-verification.json');
