#!/usr/bin/env node
/**
 * Batch 6: Lesson 4 Audio Verifier
 * Verifies Lesson 4 story scenes and lesson content
 */
...
const BATCH_CONFIG = {
  name: 'Batch 6 - Lesson 4 Audio',
  description: 'Lesson 4 content: story-04 scenes and lesson audio',
  requiredIds: [
    // Story 04 scenes (Lesson 4)
    'story-04-scene-01', 'story-04-scene-02', 'story-04-scene-03', 'story-04-scene-04',
    'story-04-scene-05', 'story-04-scene-06', 'story-04-scene-07', 'story-04-scene-08',
    // Lesson 4 content
    'lesson-4-description', 'lesson-4-full'
  ]
};
...
async function verifyBatch() {
  ...
  const reportPath = path.join(REVIEW_DIR, 'batch-6-lesson-4-audio-verification.json');
