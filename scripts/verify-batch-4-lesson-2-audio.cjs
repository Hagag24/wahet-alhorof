#!/usr/bin/env node
/**
 * Batch 4: Lesson 2 Audio Verifier
 * Verifies Lesson 2 story scenes and lesson content
 */
...
const BATCH_CONFIG = {
  name: 'Batch 4 - Lesson 2 Audio',
  description: 'Lesson 2 content: story-02 scenes and lesson audio',
  requiredIds: [
    // Story 02 scenes (Lesson 2) - only 6 scenes exist
    'story-02-scene-01', 'story-02-scene-02', 'story-02-scene-03', 'story-02-scene-04',
    'story-02-scene-05', 'story-02-scene-06',
    // Lesson 2 content
    'lesson-2-full', 'lesson-2-description'
  ]
};
...
async function verifyBatch() {
  ...
  const reportPath = path.join(REVIEW_DIR, 'batch-4-lesson-2-audio-verification.json');
