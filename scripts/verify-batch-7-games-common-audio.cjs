#!/usr/bin/env node
/**
 * Batch 7: Games Common Audio Verifier
 * Verifies game-related audio files and feedback sounds
 */
...
const BATCH_CONFIG = {
  name: 'Batch 7 - Games Common Audio',
  description: 'Game-related phrases, feedback, and common sounds',
  requiredIds: [
    // Game feedback
    'phrase-026', 'phrase-036', 'phrase-037', 'phrase-041', 'phrase-044', 'phrase-045',
    'phrase-064', 'phrase-065', 'phrase-066', 'phrase-067',
    // Game sounds and effects (if exist)
    'word-027', 'word-028', 'word-029', 'word-030', 'word-031', 'word-032',
    'word-033', 'word-034', 'word-035',
    // Game titles
    'phrase-039', 'phrase-040', 'phrase-041', 'phrase-042'
  ]
};
...
async function verifyBatch() {
  ...
  const reportPath = path.join(REVIEW_DIR, 'batch-7-games-common-audio-verification.json');
