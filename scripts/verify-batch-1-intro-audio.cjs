#!/usr/bin/env node
/**
 * Batch 1: Intro Audio Verifier
 * Verifies official and welcome intro scene audio files
 */
...
const BATCH_CONFIG = {
  name: 'Batch 1 - Intro Audio',
  description: 'Official university intro and welcome scenes',
  requiredIds: [
    'official_intro_scene_1',
    'official_intro_scene_1-2',
    'official_intro_scene_1-3',
    'official_intro_scene_1-4',
    'official_intro_scene_2',
    'official_intro_scene_3',
    'welcome_intro_scene_1',
    'welcome_intro_scene_1-2',
...
async function verifyBatch() {
  ...
  const reportPath = path.join(REVIEW_DIR, 'batch-1-intro-audio-verification.json');
